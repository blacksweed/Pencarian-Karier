...
// Struktur untuk menyimpan data karier
type Karier struct {
	Nama               string
	Industri           string
...
func showMenu() {
	...
	fmt.Println("6. Pencarian Karier (Linear Search)") // Diubah dari Binary Search
...
func main() {
	...
	for {
		...
		case "9":
			...
			return 
		default:
			fmt.Println("Pilihan tidak valid. Silakan masukkan angka antara 1-9.")
		}
	}
}
